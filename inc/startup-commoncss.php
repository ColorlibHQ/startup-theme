...
// enqueue css
function startup_common_custom_css(){
    
    wp_enqueue_style( 'startup-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= startup_opt( 'startup_theme_color' ) != '#131313' ? startup_opt( 'startup_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= startup_opt( 'startup_book_btn_color' ) != '#131313' ? startup_opt('startup_book_btn_color') : '';
		$bookBtnHoverBgColor     	= startup_opt( 'startup_book_btn_hvr_bg_color' ) != '#131313' ? startup_opt('startup_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = startup_opt( 'startup_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = startup_opt( 'startup_navbar_bg_color' ) != '#082b49' ? startup_opt( 'startup_navbar_bg_color') : '';
		$headerTop_col     		  = startup_opt( 'startup_top_header_color' );

		$headerTopBg      		  = startup_opt( 'startup_top_header_bg_color');
		$headerBg          		  = startup_opt( 'startup_header_bg_color') != '#ffffff' ? startup_opt( 'startup_header_bg_color') : '';
		$menuColor          	  = startup_opt( 'startup_header_menu_color' ) != '#131313' ? startup_opt('startup_header_menu_color') : '';
		$menuHoverColor           = startup_opt( 'startup_header_menu_hover_color' ) != '#808080' ? startup_opt('startup_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = startup_opt( 'startup_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = startup_opt( 'startup_header_drop_menu_bg_color' ) != '#ffffff' ? startup_opt('startup_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = startup_opt( 'startup_dropdown_menu_color' ) != '#131313' ? startup_opt('startup_dropdown_menu_color') : '';
		$dropMenuHovColor         = startup_opt( 'startup_dropdown_menu_hover_color' ) != '#808080' ? startup_opt('startup_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = startup_opt( 'startup_footer_widget_bg_color' );
		$footerwHeadColor   	  = startup_opt('startup_footer_widget_heading_color');
		$footerwTextColor   	  = startup_opt('startup_footer_widget_text_color');
		$footerwanchorcolor 	  = startup_opt('startup_footer_widget_anchor_color') != '#ffffff' ? startup_opt('startup_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = startup_opt('startup_footer_widget_anchor_hover_color') != '#ffffff' ? startup_opt('startup_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = startup_opt('startup_fof_bg_color');
		$foftonecolor			  = startup_opt('startup_fof_textone_color');
		$fofttwocolor			  = startup_opt('startup_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = startup_opt('startup_footer_widget_anchor_color') != '#9e9e9e' ? startup_opt('startup_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.startup_part .btn_2, .blog_area a h2:hover
			{
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .startup_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .startup_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'startup-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'startup_common_custom_css', 50 );